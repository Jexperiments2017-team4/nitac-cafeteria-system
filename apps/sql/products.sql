...
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
  values('冷やしそば', 240, '481', '17.6', '2.7', '4.7', '2017-07-03', '2017-07-31', 0, false);
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
...
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
  values('まぐろカツタルタルソース', 420, '949', '27.8', '31.1', '3.6', '2017-07-27', '2017-07-27', 1, false);
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
  values('肉じゃが(牛肉)', 420, '758', '23.3', '20.3', '4.2', '2017-07-28', '2017-07-28', 1, false);
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
...
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
  values('チャプチェ丼', 360, '932', '18.3', '25.0', '5.0', '2017-07-27', '2017-07-27', 2, false);
insert into products(name, price, energy, protein, lipid, salt, start_date, end_date, kind, has_sold_out)
  values('ソースかつ丼', 360, '779', '19.6', '19.5', '4.5', '2017-07-28', '2017-07-28', 2, false);
